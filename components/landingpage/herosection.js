      ...
      <div className="relative z-10 flex flex-col justify-end md:justify-center h-full px-4 md:px-16 lg:px-24 bg-black bg-opacity-40 pb-8 md:pb-0">
        ...
        <div className="w-full flex flex-row items-center justify-between gap-3">
          <div className="flex flex-row items-center gap-3 flex-1">
            <button className="px-4 py-2 sm:px-6 sm:py-3 bg-[#192DB7] text-white font-semibold rounded-full text-sm sm:text-base text-center flex-shrink-0">
              Mulai
            </button>
            <button className="px-4 py-2 sm:px-6 sm:py-3 bg-[#22282A] text-white font-semibold rounded-full flex items-center justify-center text-sm sm:text-base flex-shrink-0">
              <FaInfoCircle className="text-white mr-1 sm:mr-2" />
              <span>Selengkapnya</span>
            </button>
            <div className="w-10 h-8 sm:w-14 sm:h-12 rounded-full bg-black bg-opacity-60 border border-white flex items-center justify-center flex-shrink-0">
